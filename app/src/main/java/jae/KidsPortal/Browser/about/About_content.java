package jae.KidsPortal.Browser.about;
...
class About_content {
    ...
    static MaterialAboutList createMaterialAboutList(final Context c) {
        ...
        appCardBuilder.addItem(new MaterialAboutActionItem.Builder()
                ...
                .setOnClickListener(ConvenienceBuilder.createWebViewDialogOnClickAction(c, c.getString(R.string.about_changelog), "https://github.com/JaeNuguid", true, false))
                .build());
        ...
        authorCardBuilder.addItem(new MaterialAboutActionItem.Builder()
                ...
                .icon(R.drawable.jaenuguid)
                .setOnClickListener(ConvenienceBuilder.createWebViewDialogOnClickAction(c, c.getString(R.string.about_dev), "https://github.com/JaeNuguid", true, false))
                .build());
